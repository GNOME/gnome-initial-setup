                                 ...
                                 const gchar   *name)
{
        ...
        cairo_surface_write_to_png (surface,
                                    g_file_get_path (um->generated_avatar));

        /* We reserve the first position for the generated avatar.
         * Later other recent used pictures (from multiple sources)
         * would be appended to the model. */
