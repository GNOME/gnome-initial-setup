...
populate_provider_list (GisGoaPage *page)
{
  g_auto(GStrv) conf_providers =
    gis_driver_conf_get_string_list (driver, VENDOR_GOA_GROUP, VENDOR_PROVIDERS_KEY, NULL);
  gchar **providers = conf_providers ? conf_providers :
    { "google", "owncloud", "windows_live", "facebook", NULL };
